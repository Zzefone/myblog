...
- Visit [Courses](/courses/) to see the work collected for a specific class.
- Browse [Work log](/posts/) to read the newest experiments and projects in chronological order.
- Course pages will grow with assignments, code repositories, demos, and reports throughout the year.

This site is built with Hugo and deployed on GitHub Pages.
